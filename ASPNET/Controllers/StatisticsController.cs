...
namespace ASPNET.Controllers
{
    public class StatisticsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Dictionaries.Include(d => d.User).Include(d => d.Words).Include(d => d.DictionaryLevelValues).Include(d => d.Statistics);
        ...
        {
            var applicationDbContext = _context.Statistics.Include(s => s.Dictionary).Include(s => s.User).Where(s => s.DictionaryId == id);
            return View(await applicationDbContext.ToListAsync());
        }
